object frmTradeCons: TfrmTradeCons
  Left = 0
  Top = 0
  Caption = 'Consulta de Cadastro de Trades'
  ClientHeight = 380
  ClientWidth = 556
  Color = clWhite
  ...
  object grp_ListaTrades: TGroupBox
    Left = 8
    Top = 79
    Width = 540
    Height = 262
    Anchors = [akLeft, akTop, akRight, akBottom]
    Caption = 'Lista Trades'
    TabOrder = 1
    ExplicitWidth = 673
    ...
    object grd_ListaTrades: TDBGrid
      Left = 2
      Top = 18
      Width = 536
      Height = 222
