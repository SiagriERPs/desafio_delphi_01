object frmSiloCons: TfrmSiloCons
  Left = 0
  Top = 0
  Caption = 'Consulta de Cadastro de Silo'
  ClientHeight = 509
  ClientWidth = 1127
  Color = clWhite
  ...
  object grp_ListaSilo: TGroupBox
    ...
    object grd_ListaSilos: TDBGrid
      Left = 2
      Top = 18
      Width = 1107
      Height = 352
      Align = alClient
      DataSource = DM.dsSilo
      ...
      TitleFont.Style = []
      OnDrawColumnCell = grd_ListaSilosDrawColumnCell
      OnDblClick = grd_ListaSilosDblClick
      Columns = <
        item
          Expanded = False
          FieldName = 'ID'
