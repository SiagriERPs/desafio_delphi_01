...
Versão utilizada do Firebird 2.1
arquivo Config.ini (para configuração do DB) se encontra hein .\src\Win32\Debug\Config.ini
tem uma versao do DB em si .\data\DB\DBLOCAL.FDB
e outra versao no .\src\Win32\Debug\DB\DBLOCAL.FDB